...
<body>
    ...
    <div class="container-fluid">
        ...
        <form method="Post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="formFile" class="form-label">Ajouter la deuxiéme image</label>
                    <input class="form-control" type="file" name="imageProduit2">
                </div>
                <div class="mb-3">
                    <label for="formFile" class="form-label">Ajouter la troisiéme image</label>
                    <input class="form-control" type="file" name="imageProduit3">
                </div>
                <div class="mb-3">
            ...
            <?php
                if (
                    ...
                    isset($_FILES['imageProduit2']) && $_FILES['imageProduit2']['error'] == 0 &&
                    isset($_FILES['imageProduit3']) && $_FILES['imageProduit3']['error'] == 0
                ) {
                    ...
                    $imageProduit2 = uploadImage($_FILES['imageProduit2'], '../kenzatlas/assets/img/produits/');
                    $imageProduit3 = uploadImage($_FILES['imageProduit3'], '../kenzatlas/assets/img/produits/');
                    ...
                    if (!empty($imageUploadErrors)) {
                        ...
                        $sqlQuery = 'INSERT INTO produit(imageProduit1, imageProduit2, imageProduit3, nomProduit, sousTitreProduit, prixProduit , descriptionProduit, ingredientsProduit, categorieProduit , etatProduit) VALUES (:imageProduit1, :imageProduit2, :imageProduit3, :nomProduit, :sousTitreProduit, :prixProduit ,:descriptionProduit, :ingredientsProduit, :categorieProduit , :etatProduit)';
                        $insertProduit = $db->prepare($sqlQuery);
                        $insertProduit->execute([
                            'imageProduit1' => $imageProduit1,
                            'imageProduit2' => $imageProduit2,
                            'imageProduit3' => $imageProduit3,
